...
export default function FeaturesPage() {
    return (
        <div className="min-h-screen selection:bg-indigo-500/30">
            ...
            {/* --- Feature Group 1: HR & Payroll Automation --- */}
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                        ...
                        <div className="order-1 lg:order-2">
                            <span className="text-indigo-400 font-semibold tracking-wider uppercase text-sm">Feature Group 01</span>
                            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6">HR & Payroll Automation</h2>
            ...
            {/* --- Feature Group 2: Smart Workforce Tracking --- */}
            <section className="py-20 relative bg-white/[0.01]">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                        <div>
                            <span className="text-purple-400 font-semibold tracking-wider uppercase text-sm">Feature Group 02</span>
                            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6">Smart Workforce Tracking</h2>
                            <p className="text-gray-400 text-lg mb-8">
            ...
            {/* --- Feature Group 3: Mobile Empowerment --- */}
            <section className="py-20 relative">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                        <div className="order-2 lg:order-1">
                        ...
                        <div className="order-1 lg:order-2">
                            <span className="text-cyan-400 font-semibold tracking-wider uppercase text-sm">Feature Group 03</span>
                            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6">Mobile Empowerment</h2>
                            <p className="text-gray-400 text-lg mb-8">
            ...
            {/* --- Feature Group 4: Business Intelligence & AI --- */}
            <section className="py-20 relative bg-white/[0.01]">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                        <div>
                            <span className="text-pink-400 font-semibold tracking-wider uppercase text-sm">Feature Group 04</span>
                            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6">Business Intelligence & AI</h2>
                            <p className="text-gray-400 text-lg mb-8">
